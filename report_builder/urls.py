...
question_types_urls = [
    ...
    url(r'integer/admin/(?P<report_pk>\d+)/(?P<question_pk>\d*)$', integer_question.IntegerQuestionAdmin.as_view(),
        name='integer_question_admin'),
    url(r'integer/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$', integer_question.IntegerQuestionResp.as_view(),
    ...
    url(r'float/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$', float_question.FloatQuestionResp.as_view(),
        name='float_question_resp'),
    url(r'float/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)', float_question.FloatQuestionPDF.as_view(),
    ...
    url(r'simple/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)', simple_text_question.SimpleTextQuestionPDF.as_view(),
        name='simple_text_question_pdf'),
    url(r"unique/admin/(?P<report_pk>\d+)/(?P<question_pk>\d*)$", unique_selection_question.UniqueSelectionAdmin.as_view(),
    ...
    url(r"unique/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)", unique_selection_question.UniqueSelectionPDF.as_view(),
