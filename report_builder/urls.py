...
question_types_urls = [
    url(r'base/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?$',
        QuestionView.QuestionViewAdmin.as_view(),
        name='base_question_admin'),
    url(r'base/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        QuestionView.QuestionViewResp.as_view(),
        name='base_question_resp'),
    url(r'boolean/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?$',
        boolean_question.BooleanQuestionViewAdmin.as_view(),
        name='boolean_question_admin'),
    url(r'boolean/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        boolean_question.BooleanQuestionViewResp.as_view(),
        name='boolean_question_resp'),
    url(r'boolean/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        boolean_question.BooleanQuestionViewPDF.as_view(),
    ...
    url(r'boolean/csv/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        boolean_question.BooleanQuestionViewCSV.as_view(),
        name='boolean_question_csv'),
    url(r'boolean/json/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        boolean_question.BooleanQuestionViewJSON.as_view(),
        name='boolean_question_json'),
    url(r'boolean/spss/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        boolean_question.BooleanQuestionViewSPSS.as_view(),
        name='boolean_question_spss'),
    url(r'integer/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?$',
        integer_question.IntegerQuestionViewAdmin.as_view(),
        name='integer_question_admin'),
    url(r'integer/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        integer_question.IntegerQuestionViewResp.as_view(),
        name='integer_question_resp'),
    url(r'integer/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)',
        integer_question.IntegerQuestionViewPDF.as_view(),
    ...
    url(r'float/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?$',
        float_question.FloatQuestionViewAdmin.as_view(),
        name='float_question_admin'),
    url(r'float/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        float_question.FloatQuestionViewResp.as_view(),
        name='float_question_resp'),
    url(r'float/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)',
        float_question.FloatQuestionViewPDF.as_view(),
    ...
    url(r'simple/resp/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        simple_text_question.SimpleQuestionViewResp.as_view(),
        name='simple_text_question_resp'),
    url(r'simple/pdf/(?P<report_pk>\d+)/(?P<question_pk>\d+)',
        simple_text_question.SimpleTextQuestionViewPDF.as_view(),
    ...
    url(r'simple/csv/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        simple_text_question.SimpleQuestionViewCSV.as_view(),
        name='simple_text_question_csv'),
    url(r'simple/json/(?P<report_pk>\d+)/(?P<question_pk>\d+)$',
        simple_text_question.SimpleQuestionViewJSON.as_view(),
    ...
    url(r'model_info/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?',
        model_info.ModelInfoViewAdmin.as_view(),
        name='model_info_question'),
    url(r'question_model_info/admin/(?P<report_pk>\d+)/(?P<question_pk>\d+)?',
        question_model_info.QuestionModelInfoViewAdmin.as_view(),
        name='question_model_info_question')
]
...
report_views_urls = [
    ...
    url('^responsable/(?P<pk>\d+)$', Report.responsable,
        name='report_responsable'),
    url('^report_out_of_datelimits$', Report.report_out_of_datelimits,
        name='report_out_of_datelimits')
]

# Question processing
question_process_urls = [
    url(r'(?P<type>admin)/(?P<view_type>\w+)/(?P<report_pk>\d+)/(?P<question_pk>\d+)?$',
        process_question, name='process_admin'),
